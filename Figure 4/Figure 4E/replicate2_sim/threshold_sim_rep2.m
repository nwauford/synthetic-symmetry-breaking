...
if ~exist('data_sim2.mat')
    for i = 1:64
        if i < 37
            I = imread(['R_channel/sim_0' num2str(i + 63) '_cropped_1.png']);
        else
            I = imread(['R_channel/sim_' num2str(i + 63) '_cropped_1.png']);
        end
...
%         imshow(labeled)
       ...
       if i < 37
            I = imread(['Y_channel/sim_0' num2str(i + 63) '_cropped_2.png']);
        else
            I = imread(['Y_channel/sim_' num2str(i + 63) '_cropped_2.png']);
       end
%         figure('position',[31 230 643 561]);  
%         imshow(I);
        I = rgb2gray(I);
...
%         imshow(labeled)
    ...
    save('data_sim2.mat', 'numClusters')
else
    load('data_sim2.mat')
end
