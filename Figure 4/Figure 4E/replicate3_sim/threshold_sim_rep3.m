...
if ~exist('data_sim3.mat')
    for i = 1:64
         I = imread(['R_channel/sim_' num2str(i + 127) '_cropped_1.png']);
...
%         imshow(labeled)
       ...
       I = imread(['Y_channel/sim_' num2str(i + 127) '_cropped_2.png']);
...
%         imshow(labeled)
    ...
    save('data_sim3.mat', 'numClusters')
else
    load('data_sim3.mat')
end
