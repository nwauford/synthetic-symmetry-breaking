...
if ~exist('data_no_transitions_r2.mat')
    for i = 1:64
        
            I = imread(['r_images/sim_' num2str(i + 63) '_cropped_1.png']);
...
%         imshow(labeled)
        ...
        I = imread(['y_images/sim_' num2str(i + 63) '_cropped_2.png']);
%         figure('position',[31 230 643 561]);  
%         imshow(I);
        I = rgb2gray(I);
        BW = imbinarize(I, .165);
...
%         imshow(labeled)
    ...
    save('data_no_transitions_r2.mat', 'numClusters')
else
    load('data_no_transitions_r2.mat')
end
